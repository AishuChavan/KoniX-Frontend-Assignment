        ...
        <div className="flex flex-col w-1328px h-4399px ml-8 mr-8 lg:ml-16 lg:mr-16 gap-5 top-28">
            <div className="w-full lg:w-4/6 h-711px rounded-lg bg-[#FFFFFF] flex flex-col">
                ...
                <div className="ml-2 mt-6">
                    <TradingViewWidget INR={inr} USD={usd} dayChange={dayChangeValue} className="ml-2 mt-6 h-72"/>
                </div>
            </div>
            <div className="w-full md:w-3/6 lg:w-4/6 flex justify-start gap-x-12 mt-4">
